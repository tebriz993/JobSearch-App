...
{
    public class EFJobTypesRepository : EFGenericRepository<JobTypes>, IJobTypesRepository
    {
        public EFJobTypesRepository(JobSearchDbContext dbContext) : base(dbContext)
        {
        }
    }
}
